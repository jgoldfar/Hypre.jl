...
# Julia wrapper for header: /home/jgoldfar/Documents/work/projects/Hypre.jl/deps/usr/include/par_csr_pmvcomm.h
...
function hypre_ParCSRCommMultiHandleCreate(job::HYPRE_Int,comm_pkg::Ptr{hypre_ParCSRCommPkg},send_data::Ptr{Void},recv_data::Ptr{Void},nvecs::HYPRE_Int)
    ccall((:hypre_ParCSRCommMultiHandleCreate,libHYPRE),Ptr{hypre_ParCSRCommMultiHandle},(HYPRE_Int,Ptr{hypre_ParCSRCommPkg},Ptr{Void},Ptr{Void},HYPRE_Int),job,comm_pkg,send_data,recv_data,nvecs)
end

function hypre_ParCSRCommMultiHandleDestroy(comm_handle::Ptr{hypre_ParCSRCommMultiHandle})
    ccall((:hypre_ParCSRCommMultiHandleDestroy,libHYPRE),HYPRE_Int,(Ptr{hypre_ParCSRCommMultiHandle},),comm_handle)
end
