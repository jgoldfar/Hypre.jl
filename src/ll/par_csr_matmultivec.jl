...
# Julia wrapper for header: /home/jgoldfar/Documents/work/projects/Hypre.jl/deps/usr/include/par_csr_matmultivec.h
...
function hypre_ParMultiVectorDestroy(arg1::Ptr{Cint})
    ccall((:hypre_ParMultiVectorDestroy,libHYPRE),HYPRE_Int,(Ptr{Cint},),arg1)
end

function hypre_ParMultiVectorInitialize(arg1::Ptr{Cint})
    ccall((:hypre_ParMultiVectorInitialize,libHYPRE),HYPRE_Int,(Ptr{Cint},),arg1)
end

function hypre_ParMultiVectorSetDataOwner(arg1::Ptr{Cint},arg2::HYPRE_Int)
    ccall((:hypre_ParMultiVectorSetDataOwner,libHYPRE),HYPRE_Int,(Ptr{Cint},HYPRE_Int),arg1,arg2)
end

function hypre_ParMultiVectorSetPartitioningOwner(arg1::Ptr{Cint},arg2::HYPRE_Int)
    ccall((:hypre_ParMultiVectorSetPartitioningOwner,libHYPRE),HYPRE_Int,(Ptr{Cint},HYPRE_Int),arg1,arg2)
end

function hypre_ParMultiVectorSetMask(arg1::Ptr{Cint},arg2::Ptr{HYPRE_Int})
    ccall((:hypre_ParMultiVectorSetMask,libHYPRE),HYPRE_Int,(Ptr{Cint},Ptr{HYPRE_Int}),arg1,arg2)
end

function hypre_ParMultiVectorSetConstantValues(arg1::Ptr{Cint},arg2::Cdouble)
    ccall((:hypre_ParMultiVectorSetConstantValues,libHYPRE),HYPRE_Int,(Ptr{Cint},Cdouble),arg1,arg2)
end

function hypre_ParMultiVectorSetRandomValues(arg1::Ptr{Cint},arg2::HYPRE_Int)
    ccall((:hypre_ParMultiVectorSetRandomValues,libHYPRE),HYPRE_Int,(Ptr{Cint},HYPRE_Int),arg1,arg2)
end

function hypre_ParMultiVectorCopy(arg1::Ptr{Cint},arg2::Ptr{Cint})
    ccall((:hypre_ParMultiVectorCopy,libHYPRE),HYPRE_Int,(Ptr{Cint},Ptr{Cint}),arg1,arg2)
end

function hypre_ParMultiVectorScale(arg1::Cdouble,arg2::Ptr{Cint})
    ccall((:hypre_ParMultiVectorScale,libHYPRE),HYPRE_Int,(Cdouble,Ptr{Cint}),arg1,arg2)
end

function hypre_ParMultiVectorMultiScale(arg1::Ptr{Cdouble},arg2::Ptr{Cint})
    ccall((:hypre_ParMultiVectorMultiScale,libHYPRE),HYPRE_Int,(Ptr{Cdouble},Ptr{Cint}),arg1,arg2)
end

function hypre_ParMultiVectorAxpy(arg1::Cdouble,arg2::Ptr{Cint},arg3::Ptr{Cint})
    ccall((:hypre_ParMultiVectorAxpy,libHYPRE),HYPRE_Int,(Cdouble,Ptr{Cint},Ptr{Cint}),arg1,arg2,arg3)
end

function hypre_ParMultiVectorByDiag(x::Ptr{Cint},mask::Ptr{HYPRE_Int},n::HYPRE_Int,alpha::Ptr{Cdouble},y::Ptr{Cint})
    ccall((:hypre_ParMultiVectorByDiag,libHYPRE),HYPRE_Int,(Ptr{Cint},Ptr{HYPRE_Int},HYPRE_Int,Ptr{Cdouble},Ptr{Cint}),x,mask,n,alpha,y)
end

function hypre_ParMultiVectorInnerProd(arg1::Ptr{Cint},arg2::Ptr{Cint},arg3::Ptr{Cdouble},arg4::Ptr{Cdouble})
    ccall((:hypre_ParMultiVectorInnerProd,libHYPRE),HYPRE_Int,(Ptr{Cint},Ptr{Cint},Ptr{Cdouble},Ptr{Cdouble}),arg1,arg2,arg3,arg4)
end

function hypre_ParMultiVectorInnerProdDiag(arg1::Ptr{Cint},arg2::Ptr{Cint},arg3::Ptr{Cdouble},arg4::Ptr{Cdouble})
    ccall((:hypre_ParMultiVectorInnerProdDiag,libHYPRE),HYPRE_Int,(Ptr{Cint},Ptr{Cint},Ptr{Cdouble},Ptr{Cdouble}),arg1,arg2,arg3,arg4)
end

function hypre_ParMultiVectorCopyWithoutMask(x::Ptr{Cint},y::Ptr{Cint})
    ccall((:hypre_ParMultiVectorCopyWithoutMask,libHYPRE),HYPRE_Int,(Ptr{Cint},Ptr{Cint}),x,y)
end

function hypre_ParMultiVectorByMatrix(x::Ptr{Cint},rGHeight::HYPRE_Int,rHeight::HYPRE_Int,rWidth::HYPRE_Int,rVal::Ptr{Cdouble},y::Ptr{Cint})
    ccall((:hypre_ParMultiVectorByMatrix,libHYPRE),HYPRE_Int,(Ptr{Cint},HYPRE_Int,HYPRE_Int,HYPRE_Int,Ptr{Cdouble},Ptr{Cint}),x,rGHeight,rHeight,rWidth,rVal,y)
end

function hypre_ParMultiVectorXapy(x::Ptr{Cint},rGHeight::HYPRE_Int,rHeight::HYPRE_Int,rWidth::HYPRE_Int,rVal::Ptr{Cdouble},y::Ptr{Cint})
    ccall((:hypre_ParMultiVectorXapy,libHYPRE),HYPRE_Int,(Ptr{Cint},HYPRE_Int,HYPRE_Int,HYPRE_Int,Ptr{Cdouble},Ptr{Cint}),x,rGHeight,rHeight,rWidth,rVal,y)
end

function hypre_ParMultiVectorEval(f::Ptr{Void},par::Ptr{Void},x::Ptr{Cint},y::Ptr{Cint})
    ccall((:hypre_ParMultiVectorEval,libHYPRE),HYPRE_Int,(Ptr{Void},Ptr{Void},Ptr{Cint},Ptr{Cint}),f,par,x,y)
end

function hypre_ParMultiVectorTempRead()
    ccall((:hypre_ParMultiVectorTempRead,libHYPRE),Ptr{Cint},())
end

function hypre_ParMultiVectorTempPrint(vector::Ptr{Cint},file_name::Ptr{Uint8})
    ccall((:hypre_ParMultiVectorTempPrint,libHYPRE),HYPRE_Int,(Ptr{Cint},Ptr{Uint8}),vector,file_name)
end

function hypre_ParCSRMatrixMatMultiVec(arg1::Cdouble,arg2::Ptr{hypre_ParCSRMatrix},arg3::Ptr{Cint},arg4::Cdouble,arg5::Ptr{Cint})
    ccall((:hypre_ParCSRMatrixMatMultiVec,libHYPRE),HYPRE_Int,(Cdouble,Ptr{hypre_ParCSRMatrix},Ptr{Cint},Cdouble,Ptr{Cint}),arg1,arg2,arg3,arg4,arg5)
end

function hypre_ParCSRMatrixMatMultiVecT(arg1::Cdouble,arg2::Ptr{hypre_ParCSRMatrix},arg3::Ptr{Cint},arg4::Cdouble,arg5::Ptr{Cint})
    ccall((:hypre_ParCSRMatrixMatMultiVecT,libHYPRE),HYPRE_Int,(Cdouble,Ptr{hypre_ParCSRMatrix},Ptr{Cint},Cdouble,Ptr{Cint}),arg1,arg2,arg3,arg4,arg5)
end
