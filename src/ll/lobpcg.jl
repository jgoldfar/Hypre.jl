...
# Julia wrapper for header: /home/jgoldfar/Documents/work/projects/Hypre.jl/deps/usr/include/lobpcg.h
...
function lobpcg_solve(blockVectorX::mv_MultiVectorPtr,operatorAData::Ptr{Void},operatorA::Ptr{Void},operatorBData::Ptr{Void},operatorB::Ptr{Void},operatorTData::Ptr{Void},operatorT::Ptr{Void},blockVectorY::mv_MultiVectorPtr,blap_fn::lobpcg_BLASLAPACKFunctions,tolerance::lobpcg_Tolerance,maxIterations::HYPRE_Int,verbosityLevel::HYPRE_Int,iterationNumber::Ptr{HYPRE_Int},lambda_values::Ptr{Cdouble},lambdaHistory_values::Ptr{Cdouble},lambdaHistory_gh::HYPRE_Int,residualNorms_values::Ptr{Cdouble},residualNormsHistory_values::Ptr{Cdouble},residualNormsHistory_gh::HYPRE_Int)
  ccall((:lobpcg_solve,libhypre),HYPRE_Int,(mv_MultiVectorPtr,Ptr{Void},Ptr{Void},Ptr{Void},Ptr{Void},Ptr{Void},Ptr{Void},mv_MultiVectorPtr,lobpcg_BLASLAPACKFunctions,lobpcg_Tolerance,HYPRE_Int,HYPRE_Int,Ptr{HYPRE_Int},Ptr{Cdouble},Ptr{Cdouble},HYPRE_Int,Ptr{Cdouble},Ptr{Cdouble},HYPRE_Int),blockVectorX,operatorAData,operatorA,operatorBData,operatorB,operatorTData,operatorT,blockVectorY,blap_fn,tolerance,maxIterations,verbosityLevel,iterationNumber,lambda_values,lambdaHistory_values,lambdaHistory_gh,residualNorms_values,residualNormsHistory_values,residualNormsHistory_gh)
end
